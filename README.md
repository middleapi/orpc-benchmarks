...
| `typecheck` | [typecheck-orpc](./benchmarks/typecheck-orpc), [typecheck-hono](./benchmarks/typecheck-hono), [typecheck-trpc](./benchmarks/typecheck-trpc) | TypeScript type-checking time on a large, fully typed project |
